<div class="space-y-6 max-w-7xl mx-auto">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Class Result Report</h1>
    ...
    @if(!$classId)
        <div class="glass-card p-12 text-center rounded-2xl">
            <p class="text-red-500 font-medium">No class assigned to you.</p>
        </div>
    @else
        {{-- Controls --}}
