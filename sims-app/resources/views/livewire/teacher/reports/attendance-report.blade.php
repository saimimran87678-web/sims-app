<div class="space-y-6 max-w-6xl mx-auto">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p className="text-gray-500">View and export monthly attendance summary for your class</p>
        </div>
    </div>
    ...
    <div class="glass-card p-6 rounded-2xl">
        @if($hasError)
            <div class="p-4 text-red-700 bg-red-50 rounded-lg mb-4">
                {{ $errorMessage }}
            </div>
        @else
            <form wire:submit="generate" class="flex flex-col md:flex-row gap-4 items-end">
                ...
                <div class="w-full md:w-64">
                    ...
                    @if(count($classes) > 1)
                        <select wire:model.live="selectedClass" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none bg-white">
    ...
    @elseif(!$hasError && !$isLoading && $selectedMonth)
         <div class="glass-card p-12 text-center rounded-2xl">
