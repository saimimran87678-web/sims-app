<div class="space-y-6 max-w-6xl mx-auto">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Admin Gradebook</h1>
            <p class="text-gray-500">Manage student grades for any class</p>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-gray-50 {{ $isAbsent ? 'bg-orange-50' : '' }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <input
                                ...
                                @if(!$isGradingAllowed) disabled @endif
                            />
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input
                                ...
                                @if(!$isGradingAllowed || $isAbsent) disabled @endif
                            />
                        </td>
