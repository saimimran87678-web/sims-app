            ...
            <div class="glass-card p-6 rounded-2xl space-y-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 max-h-40 overflow-y-auto p-2 border rounded-lg bg-gray-50 uppercase text-xs font-semibold">
                        ...
                        @if(empty($classes))
                            <p class="text-sm text-gray-500 italic">No classes found.</p>
                        @endif
                    </div>
                ...
                <div class="space-y-4 pt-4 border-t">
                    ...
                    @if(in_array($messageType, ['image', 'document']))
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center">
                            <input type="file" wire:model="attachment" class="hidden" id="file-upload" accept="{{ $messageType === 'image' ? 'image/*' : '.pdf,.doc,.docx' }}">
        ...
        <div class="space-y-6">
            <div class="glass-card p-6 rounded-2xl bg-blue-50 border border-blue-100">
                ...
                <ul class="text-sm text-blue-700 space-y-2">
                    ...
                    <li>• You can select "Toggle All" to select all students in a class.</li>
                    <li>• Uncheck specific students to exclude them.</li>
                    <li>• Hold button to record voice notes instantly!</li>
                </ul>
            </div>
        </div>
    </div>
