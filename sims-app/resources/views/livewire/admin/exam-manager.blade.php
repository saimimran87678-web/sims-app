    ...
    <div class="glass-card p-4 rounded-2xl flex items-center gap-4">
        ...
        <div class="relative w-52">
             ...
             <select 
                ...
                class="w-full pl-9 pr-10 py-2 bg-gray-50 dark:bg-gray-800 border-none rounded-xl focus:ring-2 focus:ring-blue-500/20 text-gray-700 dark:text-gray-300 text-sm appearance-none cursor-pointer"
            >
