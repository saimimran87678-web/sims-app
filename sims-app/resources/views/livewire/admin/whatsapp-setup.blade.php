            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                ...
                <div class="md:col-span-5 flex justify-end items-center gap-3">
                    @if (session()->has('message'))
                        <span class="text-sm font-bold text-green-600 flex items-center gap-1" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-transition.duration.500ms>
                    ...
                    @if (session()->has('error'))
                        <span class="text-sm font-bold text-red-600 flex items-center gap-1" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-transition.duration.500ms>
                    ...
                    @endif
                    <button wire:click="processQueue(true)" class="px-5 py-2 bg-blue-100 text-blue-700 hover:bg-blue-200 rounded-lg transition-colors text-sm font-bold shadow-sm inline-flex items-center gap-2">
                        <span wire:loading.remove wire:target="processQueue(true)">Process Queue Now</span>
                        <span wire:loading wire:target="processQueue(true)" class="inline-flex items-center gap-2">
