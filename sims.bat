...
:: Resolve root directory of SIMS installation
set "ROOT_DIR=%~dp0"
...
:: 1. Check Port 443 & 80 with clean GOTO flow (NO pipes in parens)
...
echo Access application securely at:
echo   🔒 https://localhost
echo   🔒 https://sims.local
echo   🔒 https://%COMPUTERNAME%.local
echo ====================================================
